...
export const FacebookIcon = (props: IconType) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M448 56.7v398.5c0 31.3-25.4 56.7-56.7 56.7H56.7C25.4 512 0 486.6 0 455.3V56.7C0 25.4 25.4 0 56.7 0h334.6C422.6 0 448 25.4 448 56.7zM372.3 56.7h-56.7c-31.3 0-56.7 25.4-56.7 56.7v56.7h-56.7v56.7h56.7v170.7h56.7V226.7h56.7l28.3-56.7h-85V113.4c0-15.7 12.7-28.3 28.3-28.3h56.7V56.7z"></path>
  </svg>
);
...
export const InstagramIcon = (props: IconType) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9 114.9-51.3 114.9-114.9-51.3-114.9-114.9-114.9zm0 186.6c-39.6 0-71.7-32.1-71.7-71.7s32.1-71.7 71.7-71.7 71.7 32.1 71.7 71.7-32.1 71.7-71.7 71.7zm146.4-194.3c0 14.9-12.1 27-27 27s-27-12.1-27-27 12.1-27 27-27 27 12.1 27 27zm76.1 27.2c-1.7-35.7-9.9-67.3-36.2-92.6-26.3-25.3-58.9-33.5-94.6-35.2-37.2-2.1-148.8-2.1-186 0-35.7 1.7-68.3 9.9-94.6 35.2-26.3 25.3-34.5 56.9-36.2 92.6-2.1 37.2-2.1 148.8 0 186 1.7 35.7 9.9 67.3 36.2 92.6 26.3 25.3 58.9 33.5 94.6 35.2 37.2 2.1 148.8 2.1 186 0 35.7-1.7 68.3-9.9 94.6-35.2 26.3-25.3 34.5-56.9 36.2-92.6 2.1-37.2 2.1-148.8 0-186zm-48.5 224c-7.8 19.6-22.9 34.7-42.5 42.5-29.4 11.7-99.2 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.5-42.5-11.7-29.4-9-99.2-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.5-42.5 29.4-11.7 99.2-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.5 42.5 11.7 29.4 9 99.2 9 132.1s2.7 102.7-9 132.1z"></path>
  </svg>
);
